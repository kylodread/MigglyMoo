...
class SystemButtonGroup extends StatelessWidget {
  static const _systemButtonColor = Color.fromARGB(255, 155, 33, 33);
      ...
      children: <Widget>[
        ...
        _Description(
          ...
          child: _Button(
              size: _SYSTEM_BUTTON_SIZE,
              enableLongPress: false,
              color: Color.fromARGB(255, 145, 46, 238),
              onTap: () {
                Game.of(context).reset();
                Vibration.vibrate(duration: 750, amplitude: 1);
              }),
        )
      ],
    );
...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTextStyle(
      child: widget,
      style: TextStyle(
          fontFamily: 'Silkscreen', fontSize: 12, color: Colors.white),
    );
  }
}
